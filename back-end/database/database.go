...
func New(db *gorm.DB) gin.HandlerFunc {
	...
	sqlStatements := []string{
		...
		INSERT INTO ride VALUES('beta', 'via fratellino', 'via sorellina','20/11/2001 12:00','micio','e50490db-c90d-4fb6-b593-c9c76b0ba616', '4');
		INSERT INTO ride VALUES('charlie', 'via fratellino', 'via sorellina','20/11/2001 12:00','micio','e50490db-c90d-4fb6-b593-c9c76b0ba616', '4');
